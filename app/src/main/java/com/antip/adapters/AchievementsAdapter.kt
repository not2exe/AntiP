...
class AchievementsAdapter(private var list: ArrayList<Achievement>) :
    RecyclerView.Adapter<com.antip.adapters.AchievementsAdapter.AchievementsHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): _root_ide_package_.com.antip.adapters.AchievementsAdapter.AchievementsHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.achievements_item, parent, false)
        return _root_ide_package_.com.antip.adapters.AchievementsAdapter.AchievementsHolder(view)
    }

    override fun onBindViewHolder(holder: _root_ide_package_.com.antip.adapters.AchievementsAdapter.AchievementsHolder, position: Int) {
