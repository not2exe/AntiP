...
import com.example.antip.adapters.AchievementsAdapter
...
class AchievementsFragment : Fragment(R.layout.fragment_achievements) {
    ...
    private fun initObservers() {
        viewModel.achievements.observe(viewLifecycleOwner) {
            ...
            (binding.achievementsTable.adapter as AchievementsAdapter).updateList(achievementsList)
        }
    ...
    private fun RecyclerView.init(list: ArrayList<Achievement>) {
        ...
        val adapter = AchievementsAdapter(list)
